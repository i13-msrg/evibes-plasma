...
export class PlasmaEffects {
    ...
    @Effect({dispatch: false}) subscribeToSimulatorTopics$: Observable<Action> = this.actions$.pipe(
        ...
        tap((action) => {
            ...
            this.plasmaEventBusService.subscribeToAction(PlasmaAction.PlasmaActionTypes.PARENT_BLOCK_RECEIVED);
            this.plasmaEventBusService.subscribeToAction(PlasmaAction.PlasmaActionTypes.PROPAGATION_INFO);
            this.plasmaEventBusService.subscribeToAction(PlasmaAction.PlasmaActionTypes.SIMULATION_STOPPED);
        })
    );
    ...
    @Effect({dispatch: false}) unsubscribeToSimulatorTopics$: Observable<Action> = this.actions$.pipe(
        ...
        tap((action) => {
            ...
            this.plasmaEventBusService.unsubscribeFromAction(PlasmaAction.PlasmaActionTypes.PARENT_BLOCK_RECEIVED);
            this.plasmaEventBusService.unsubscribeFromAction(PlasmaAction.PlasmaActionTypes.PROPAGATION_INFO);
            this.plasmaEventBusService.unsubscribeFromAction(PlasmaAction.PlasmaActionTypes.SIMULATION_STOPPED);
